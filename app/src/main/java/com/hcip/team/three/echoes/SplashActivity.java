...
public class SplashActivity extends AppCompatActivity {
    ...
    private void generateFriends() {
        ...
        friends.add(new Friend(0, "Joanna Mills", echoesApplication.imageEncoder(R.drawable.img_profile_you, false), true));
        friends.add(new Friend(1, "Caroline Black", echoesApplication.imageEncoder(R.drawable.img_profile_caroline, false), false));
        friends.add(new Friend(2, "Amy Adams", echoesApplication.imageEncoder(R.drawable.img_profile_amy, false), false));
        friends.add(new Friend(3, "Frank Benson", echoesApplication.imageEncoder(R.drawable.img_profile_frank, false), false));
        friends.add(new Friend(4, "Mike Geller", echoesApplication.imageEncoder(R.drawable.img_profile_mike, false), false));
        friends.add(new Friend(5, "Billy Jackson", echoesApplication.imageEncoder(R.drawable.img_profile_billy, false), false));
        friends.add(new Friend(6, "Mark Jobs", echoesApplication.imageEncoder(R.drawable.img_profile_mark, false), false));
